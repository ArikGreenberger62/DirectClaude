...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  */
    ...
    PA1     ------> UART4_RX
    */
    GPIO_InitStruct.Pin = RS232_UART4_TX_Pin|RS232_UART4_RX_Pin;
    ...
    handle_GPDMA2_Channel3.Init.Request = GPDMA2_REQUEST_UART4_TX;
  ...
  */
    ...
    PE8     ------> UART7_TX
    */
    GPIO_InitStruct.Pin = H_CON_UART7_RX_Pin|H_CON_UART7_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
    ...
    handle_GPDMA2_Channel4.Init.Request = GPDMA2_REQUEST_UART7_TX;
  ...
  */
    ...
    PD15     ------> UART9_TX
    */
    GPIO_InitStruct.Pin = WIFI_UART9_RX_Pin|WIFI_UART9_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
    ...
    /* UART9 DMA Init */
    /* GPDMA2_REQUEST_UART9_TX Init */
    handle_GPDMA2_Channel5.Instance = GPDMA2_Channel5;
    handle_GPDMA2_Channel5.Init.Request = GPDMA2_REQUEST_UART9_TX;
    ...
    HAL_NVIC_SetPriority(UART9_IRQn, 12, 0);
  ...
  */
    ...
    PD4     ------> USART2_RTS
    */
    GPIO_InitStruct.Pin = MDM_USART2_TX_Pin|MDM_USART2_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
    ...
    GPIO_InitStruct.Pin = MDM_USART2_CTS_Pin|MDM_USART2_RTS_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF7_USART2;
  ...
  */
    ...
    PB11     ------> USART3_RX
    */
    GPIO_InitStruct.Pin = GNSS_USART3_TX_Pin|GNSS_USART3_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
    ...
    handle_GPDMA2_Channel2.Init.Request = GPDMA2_REQUEST_USART3_TX;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END UART4_MspDeInit 0 */
    ...
    PA1     ------> UART4_RX
    */
    HAL_GPIO_DeInit(GPIOA, RS232_UART4_TX_Pin|RS232_UART4_RX_Pin);
  ...
  /* USER CODE END UART7_MspDeInit 0 */
    ...
    PE8     ------> UART7_TX
    */
    HAL_GPIO_DeInit(GPIOE, H_CON_UART7_RX_Pin|H_CON_UART7_TX_Pin);
  ...
  /* USER CODE END UART9_MspDeInit 0 */
    ...
    PD15     ------> UART9_TX
    */
    HAL_GPIO_DeInit(GPIOD, WIFI_UART9_RX_Pin|WIFI_UART9_TX_Pin);
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    PA10     ------> USART1_RX
    */
    HAL_GPIO_DeInit(GPIOA, RS485_USART1_TX_Pin|RS485_USART1_RX_Pin);
  ...
  /* USER CODE END USART2_MspDeInit 0 */
    ...
    PD4     ------> USART2_RTS
    */
    HAL_GPIO_DeInit(GPIOA, MDM_USART2_TX_Pin|MDM_USART2_RX_Pin);

    HAL_GPIO_DeInit(GPIOD, MDM_USART2_CTS_Pin|MDM_USART2_RTS_Pin);
  ...
  /* USER CODE END USART3_MspDeInit 0 */
    ...
    PB11     ------> USART3_RX
    */
    HAL_GPIO_DeInit(GPIOB, GNSS_USART3_TX_Pin|GNSS_USART3_RX_Pin);
