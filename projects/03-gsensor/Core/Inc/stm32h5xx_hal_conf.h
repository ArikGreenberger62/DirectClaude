/* stm32h5xx_hal_conf.h — HAL module enable for 03-gsensor project */
...
/* NOTE: HAL_ICACHE_MODULE_ENABLED is intentionally omitted — not needed for
 *       basic peripheral operation and causes spurious init failures. */
...
/* ── Include individual HAL headers ─────────────────────────────────────── */
