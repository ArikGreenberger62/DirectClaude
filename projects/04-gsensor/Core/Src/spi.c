...
/**
  ...
  *          modified for 04-gsensor:
  *          SPI1 changed to Mode 3 (CPOL=HIGH, CPHA=2EDGE) for LSM6DSO,
  *          BaudRatePrescaler set to 16 (7.5 MHz at PLL1Q=120 MHz),
  *          NSSPMode set to DISABLE (software NSS via GPIO PE9).
  *          SPI2 and SPI4 are unchanged from CubeMX output.
  ******************************************************************************
  */
...
/* SPI1 init function — Mode 3, 7.5 MHz (PLL1Q 120 MHz / 16) for LSM6DSO */
void MX_SPI1_Init(void)
{
  ...
  hspi1.Init.CLKPolarity = SPI_POLARITY_HIGH;          /* Mode 3: CPOL=1 */
  hspi1.Init.CLKPhase = SPI_PHASE_2EDGE;               /* Mode 3: CPHA=1 */
  hspi1.Init.NSS = SPI_NSS_SOFT;
  hspi1.Init.BaudRatePrescaler = SPI_BAUDRATEPRESCALER_16; /* 120 MHz / 16 = 7.5 MHz */
  hspi1.Init.FirstBit = SPI_FIRSTBIT_MSB;
  hspi1.Init.TIMode = SPI_TIMODE_DISABLE;
  hspi1.Init.CRCCalculation = SPI_CRCCALCULATION_DISABLE;
  hspi1.Init.CRCPolynomial = 0x7;
  hspi1.Init.NSSPMode = SPI_NSS_PULSE_DISABLE;         /* software NSS — no auto pulse */
