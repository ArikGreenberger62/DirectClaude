...
/**
  ******************************************************************************
  * @file    spi.c
  * @brief   SPI peripheral configuration — generated by STM32CubeMX,
  *          modified for 05-psram:
  *          SPI2 changed to BaudRatePrescaler_2 (60 MHz at PLL1Q=120 MHz)
  *          for IS66WVS16M8FBLL PSRAM (FAST READ requires > 33 MHz).
  *          SPI2 NSSPMode set to DISABLE (software CS via GPIO PE13).
  *          SPI1 and SPI4 are unchanged from CubeMX output.
  ******************************************************************************
  */
...
/* SPI1 init function — Mode 3, 7.5 MHz (PLL1Q 120 MHz / 16) */
...
/* SPI2 init function — Mode 0, 60 MHz (PCLK1 240 MHz / 4) for IS66WVS16M8FBLL PSRAM
 * NOTE: SPI2 has no PLL1Q mux on STM32H573 — kernel clock is always PCLK1 = 240 MHz.
 * Prescaler 4 → 60 MHz (within 104 MHz max; tCEM: 24B write=3.2µs, 25B read=3.33µs < 4µs). */
void MX_SPI2_Init(void)
{
  ...
  hspi2.Init.BaudRatePrescaler = SPI_BAUDRATEPRESCALER_4; /* PCLK1 240 MHz / 4 = 60 MHz */
  hspi2.Init.FirstBit = SPI_FIRSTBIT_MSB;
  hspi2.Init.TIMode = SPI_TIMODE_DISABLE;
  hspi2.Init.CRCCalculation = SPI_CRCCALCULATION_DISABLE;
  hspi2.Init.CRCPolynomial = 0x7;
  hspi2.Init.NSSPMode = SPI_NSS_PULSE_DISABLE;         /* software CS via PE13 */
  hspi2.Init.NSSPolarity = SPI_NSS_POLARITY_LOW;
  hspi2.Init.FifoThreshold = SPI_FIFO_THRESHOLD_01DATA;
  hspi2.Init.MasterSSIdleness = SPI_MASTER_SS_IDLENESS_00CYCLE;
  hspi2.Init.MasterInterDataIdleness = SPI_MASTER_INTERDATA_IDLENESS_00CYCLE;
  hspi2.Init.MasterReceiverAutoSusp = SPI_MASTER_RX_AUTOSUSP_DISABLE;
  hspi2.Init.MasterKeepIOState = SPI_MASTER_KEEP_IO_STATE_DISABLE; /* Mode 0: safe without AFCNTR */
