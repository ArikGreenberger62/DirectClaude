/**
 * @file main.h
 * @brief 14-ignition-rg — Read ADC IgnitionPCO (PC0/CH10) and control
 *        LED_G (PC9) and LED_R (PC8):
 *          raw > 300  ->  LED_G ON,  LED_R OFF
 *          raw <= 300 ->  LED_R ON,  LED_G OFF
 *        P3V3_SW_EN (PC11) permanently ON.
